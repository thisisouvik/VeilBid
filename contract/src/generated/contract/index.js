...
(function (AuctionStatus) {
  ...
  AuctionStatus[AuctionStatus['SETTLED'] = 1] = 'SETTLED';
  AuctionStatus[AuctionStatus['EXPIRED'] = 2] = 'EXPIRED';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.reserve_price) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named reserve_price');
    }
    if (typeof(witnesses_0.commitment_salt) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named commitment_salt');
    }
    ...
    this.circuits = {
      createAuction: (...args_1) => {
        ...
        const duration_blocks_0 = args_1[1];
        const item_hash_input_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createAuction',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 139 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(duration_blocks_0) === 'bigint' && duration_blocks_0 >= 0n && duration_blocks_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('createAuction',
        ...
        if (!(item_hash_input_0.buffer instanceof ArrayBuffer && item_hash_input_0.BYTES_PER_ELEMENT === 1 && item_hash_input_0.length === 32)) {
          __compactRuntime.typeError('createAuction',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(duration_blocks_0).concat(_descriptor_2.toValue(item_hash_input_0)),
      ...
      placeBid: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const bid_amount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('placeBid',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 179 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(bid_amount_0) === 'bigint' && bid_amount_0 >= 0n && bid_amount_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('placeBid',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'auction.compact line 179 char 1',
                                     'Uint<0..18446744073709551616>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(bid_amount_0),
      ...
      withdrawExpired: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`withdrawExpired: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._withdrawExpired_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      ...
      withdrawExpired: this.circuits.withdrawExpired
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('withdrawExpired', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(new Uint8Array(32)),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._persistentHash_0(this._local_secret_key_0(context,
                                                                  partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _reserve_price_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.reserve_price(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('reserve_price',
                                 'return value',
                                 'auction.compact line 100 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _commitment_salt_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.commitment_salt(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('commitment_salt',
                                 'return value',
                   ...
                   item_hash_input_0)
  {
    __compactRuntime.assert(this._equal_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                          ...
                                          this._persistentHash_0(this._local_secret_key_0(context,
                                                                                          partialProofData))),
    ...
    __compactRuntime.assert(duration_blocks_0 > 0n,
                            'Duration must be > 0 blocks');
    const commitment_0 = this._persistentHash_0(this._commitment_salt_0(context,
                                                                        partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(4n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(duration_blocks_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(7n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(item_hash_input_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _placeBid_0(context, partialProofData, bid_amount_0) {
    ...
    __compactRuntime.assert((t_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             ...
                                                                                             [
                                                                                              ...
                                                                                              { popeq: { cached: false,
                                                                                                         result: undefined } }]).value),
                             t_0 > 0n),
                            'Auction not yet configured');
    __compactRuntime.assert(bid_amount_0
                            >
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(2n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(bid_amount_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(3n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(bidder_key_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
  ...
  _settle_0(context, partialProofData) {
    ...
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            0,
                            'Auction already settled or expired');
    let t_0;
    __compactRuntime.assert((t_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
    ...
    __compactRuntime.assert(this._equal_4(recomputed_0,
                                          _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Invalid reserve commitment: wrong price or salt');
    let t_1;
    const met_0 = (t_1 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                   partialProofData,
                                                                                   [
                                                                                    { dup: { n: 0 } },
                                                                                    { idx: { cached: false,
                                                                                    ...
                                                                                    { popeq: { cached: false,
                                                                                               result: undefined } }]).value),
                   t_1 >= this._reserve_price_0(context, partialProofData));
    if (met_0) {
      __compactRuntime.queryLedgerState(context,
                                        partialProofData,
                                        [
  ...
  _withdrawExpired_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const is_bidder_0 = this._equal_6(caller_key_0,
                                      _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                ...
                                                                                                [
                                                                                                 ...
                                                                                                 { popeq: { cached: false,
                                                                                                            result: undefined } }]).value));
    __compactRuntime.assert(is_seller_0 || is_bidder_0,
...
const _dummyContract = new Contract({
  ...
  reserve_price: (...args) => undefined,
  commitment_salt: (...args) => undefined
});
